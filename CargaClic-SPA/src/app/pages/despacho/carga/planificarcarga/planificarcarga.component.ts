...
@Component({
  selector: 'app-planificarcarga',
  templateUrl: './planificarcarga.component.html',
  styleUrls: ['./planificarcarga.component.css']
})
export class PlanificarcargaComponent implements OnInit {
  ...
  planificar(){
    ...
    this.ordensalidaService.RegistarPlanificacion(this.model_pendientes).subscribe(resp => {
       console.log(resp);
    })
